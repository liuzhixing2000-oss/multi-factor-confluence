...
def run():
    try:
        end=int(time.time()//900)*900000-1
        report={'run_id':f'fixed-v01-{end}','end_request_ms':end,'bars_per_symbol':35040,'test_fraction':.3,'source':'Bybit linear USDT 15m','costs':{'fee_bps_per_side':6,'slippage_bps_per_side':3,'funding_stress_bps_per_8h':1},'results':{}}
